...
<script>
    ...
    function openModal(oper,id) {
        ...
        if("edit"==oper){
            ...
            $("#article-author").val(article.startId);
    ...
    function  delModal(id){
        var article = $("#articleTable").jqGrid("getRowData",id);
        var id =$("#article-id").val(article.id);
        var url="${pageContext.request.contextPath}/article/del";
        $.ajax({
            url:url,
            type:"get",
            data:id,
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="article-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="startId" class="form-control" id="article-author" placeholder="请输入文章作者">
                        </div>
                    </div>
                    <div class="form-group">
